...
import Foundation
    public class ChallengeResponse: ChallengeResponseDelegate {
        ...
        public func generateOcra(ocraSuite: String, secret: [UInt8], counter: String?, challenge: String, password: String?, sessionInformation: String?, timeStamp: String?) -> String? {
            var counter = counter
            ...
            var result: String?
            let ocraSuiteLength = [UInt8](ocraSuite.utf8).count
            var counterLength = 0
...
//            msg = bArray.map{$0}
            ...
            if (counterLength > 0) {
                ...
                for i in 0...bArray.count-1 {
                    msg[ocraSuiteLength + 1 + i] = bArray[i]
                }
            }
            ...
            if (questionLength > 0) {
                bArray = challenge.hexaToBytes()
                for i in 0...bArray.count-1 {
                    msg[ocraSuiteLength + 1 + counterLength + i] = bArray[i]
                }
            }
            ...
            if (passwordLength > 0) {
                ...
                for i in 0...bArray.count-1 {
                    msg[ocraSuiteLength + 1 + counterLength + questionLength + i] = bArray[i]
                }
            }
            ...
            if (sessionInformationLength > 0) {
                ...
                for i in 0...bArray.count-1 {
                    msg[ocraSuiteLength + 1 + counterLength + questionLength + passwordLength + i] = bArray[i]
                }
            }
            ...
            if (timeStampLength > 0) {
                ...
                for i in 0...bArray.count-1 {
                    msg[ocraSuiteLength + 1 + counterLength + questionLength + passwordLength + sessionInformationLength + i] = bArray[i]
                }
            }
            ...
            var hash = [UInt8]()
            do{
                hash = try HMAC(key: bArray, variant: crypto!).authenticate(msg)
            } catch{
...
//        func generateOCRA(ocraSuite: String, key: String, counter: String, challenge: String, password: String, sessionInformation: String, timeStamp: String) {
//            var counter = counter
//            var challenge = challenge
//            var password = password
//            var timeStamp = timeStamp
